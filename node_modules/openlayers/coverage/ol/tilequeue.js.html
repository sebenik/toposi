...
<html lang="en">
<head>
    <title>Code coverage report for ol/tilequeue.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ol/</a> tilequeue.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.TilePriorityFunction');
...
ol.TileQueue.prototype.enqueue = function(element) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (added) {
    var tile = element[0];
