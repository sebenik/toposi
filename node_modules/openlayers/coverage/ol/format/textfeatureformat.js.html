...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/textfeatureformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> textfeatureformat.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.TextFeature');
&nbsp;
...
ol.format.TextFeature.prototype.getText_ = function(source) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    return source;
  } else {
 ...
 * @inheritDoc
 */
ol.format.TextFeature.prototype.getType = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return ol.format.FormatType.TEXT;</span>
};
&nbsp;
&nbsp;
/**
