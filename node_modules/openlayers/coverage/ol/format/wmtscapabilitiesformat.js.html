...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/wmtscapabilitiesformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> wmtscapabilitiesformat.js
    </h1>
    <div class='clearfix'>
...
433
434
435</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.WMTSCapabilities');
&nbsp;
...
ol.format.WMTSCapabilities.prototype.readFromNode = function(node) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!WMTSCapabilityObject) {
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
  WMTSCapabilityObject['version'] = version;
  WMTSCapabilityObject = ol.xml.pushParseAndPop(WMTSCapabilityObject,
      ol.format.WMTSCapabilities.PARSERS_, node, []);
  return WMTSCapabilityObject ? WMTSCapabilityObject : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
};
&nbsp;
&nbsp;
/**
...
ol.format.WMTSCapabilities.readResourceUrl_ = function(node, objectStack) {
  ...
  var resource = {};
  <span class="missing-if-branch" title="else path not taken" >E</span>if (format) {
    resource['format'] = format;
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (template) {
    resource['template'] = template;
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (resourceType) {
...
ol.format.WMTSCapabilities.readWgs84BoundingBox_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (coordinates.length != 2) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
...
ol.format.WMTSCapabilities.readCoordinates_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!coordinates || coordinates.length != 2) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
  var x = +coordinates[0];
  var y = +coordinates[1];
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(x) || isNaN(y)) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
  return [x, y];
};
