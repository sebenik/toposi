...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/esrijsonformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> esrijsonformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">98.33% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>235/239</span>
      </div>
      <div class='fl pad1y space-right2'>
...
698
699
700</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.EsriJSON');
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return null;</span>
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (object.rings) {
...
ol.format.EsriJSON.convertRings_ = function(rings, layout) {
  ...
  while (holes.length) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!matched) {
      // no outer rings contain this hole turn it into and outer
      // ring (reverse it)
<span class="cstat-no" title="statement not covered" >      outerRings.push([hole.reverse()]);</span>
    }
  }
  return outerRings;
};
...
ol.format.EsriJSON.writePointGeometry_ = function(geometry, opt_options) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (layout === ol.geom.GeometryLayout.XY) {
    return /** @type {EsriJSONPoint} */ ({
      x: coordinates[0],
      y: coordinates[1]
    });
...
<span class="branch-1 cbranch-no" title="branch not covered" >      esriJSONFeature.attributes,</span>
...
ol.format.EsriJSON.prototype.readProjectionFromObject = function(object) {
  var esriJSONObject = /** @type {EsriJSONObject} */ (object);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (esriJSONObject.spatialReference &amp;&amp; esriJSONObject.spatialReference.wkid) {
