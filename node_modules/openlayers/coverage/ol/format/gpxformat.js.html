...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/gpxformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> gpxformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.8% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>235/256</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">55.36% </span>
...
901
902
903</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">15×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.GPX');
&nbsp;
...
ol.format.GPX.parseLink_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (href !== null) {
    values['link'] = href;
  }
...
ol.format.GPX.parseRtePt_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (values) {
...
ol.format.GPX.readRte_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!values) {
...
<span class="cstat-no" title="statement not covered" >    features = [];</span>
  ...
  for (var i = 0, ii = features.length; i &lt; ii; ++i) {
    ...
    if (this.readExtensions_) {
      var extensionsNode = feature.get('extensionsNode_') || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
 ...
 * @inheritDoc
 */
ol.format.GPX.prototype.readFeatureFromNode = <span class="fstat-no" title="function not covered" >function(node, opt_options) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,</span>
      'node.nodeType should be ELEMENT');
<span class="cstat-no" title="statement not covered" >  if (!ol.array.includes(ol.format.GPX.NAMESPACE_URIS_, node.namespaceURI)) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
<span class="cstat-no" title="statement not covered" >  var featureReader = ol.format.GPX.FEATURE_READER_[node.localName];</span>
<span class="cstat-no" title="statement not covered" >  if (!featureReader) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
<span class="cstat-no" title="statement not covered" >  var feature = featureReader(node, [this.getReadOptions(node, opt_options)]);</span>
<span class="cstat-no" title="statement not covered" >  if (!feature) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
<span class="cstat-no" title="statement not covered" >  this.handleReadExtensions_([feature]);</span>
...
ol.format.GPX.prototype.readFeaturesFromNode = function(node, opt_options) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ol.array.includes(ol.format.GPX.NAMESPACE_URIS_, node.namespaceURI)) {
<span class="cstat-no" title="statement not covered" >    return [];</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (node.localName == 'gpx') {
...
ol.format.GPX.writeWptType_ = function(node, coordinate, objectStack) {
  ...
  switch (geometryLayout) {
    ...
    case ol.geom.GeometryLayout.XYZ:
      ...
      break;
<span class="branch-2 cbranch-no" title="branch not covered" >    case ol.geom.GeometryLayout.XYM:</span>
<span class="cstat-no" title="statement not covered" >      if (coordinate[2] !== 0) {</span>
<span class="cstat-no" title="statement not covered" >        properties['time'] = coordinate[2];</span>
      }
...
ol.format.GPX.writeRte_ = function(node, feature, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (geometry) {
