...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/topojsonformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> topojsonformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.21% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>129/143</span>
      </div>
      <div class='fl pad1y space-right2'>
...
406
407
408</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">420×</span>
<span class="cline-any cline-yes">420×</span>
<span class="cline-any cline-yes">1681×</span>
<span class="cline-any cline-yes">1681×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1261×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1681×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">420×</span>
<span class="cline-any cline-yes">15728×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">420×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-yes">986×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">986×</span>
<span class="cline-any cline-yes">986×</span>
<span class="cline-any cline-yes">9595×</span>
<span class="cline-any cline-yes">9595×</span>
<span class="cline-any cline-yes">9595×</span>
<span class="cline-any cline-yes">9595×</span>
<span class="cline-any cline-yes">9595×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.TopoJSON');
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >          options.defaultDataProjection </span>: 'EPSG:4326');
&nbsp;
};
...
ol.format.TopoJSON.readPointGeometry_ = function(object, scale, translate) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (scale &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >translate)</span> {
<span class="cstat-no" title="statement not covered" >    ol.format.TopoJSON.transformVertex_(coordinates, scale, translate);</span>
  }
 ...
 * @private
 */
ol.format.TopoJSON.readMultiPointGeometry_ = <span class="fstat-no" title="function not covered" >function(object, scale,</span>
    translate) {
<span class="cstat-no" title="statement not covered" >  var coordinates = object.coordinates;</span>
<span class="cstat-no" title="statement not covered" >  var i, ii;</span>
<span class="cstat-no" title="statement not covered" >  if (scale &amp;&amp; translate) {</span>
<span class="cstat-no" title="statement not covered" >    for (i = 0, ii = coordinates.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      ol.format.TopoJSON.transformVertex_(coordinates[i], scale, translate);</span>
    }
  }
<span class="cstat-no" title="statement not covered" >  return new ol.geom.MultiPoint(coordinates);</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @private
 */
ol.format.TopoJSON.readMultiLineStringGeometry_ = <span class="fstat-no" title="function not covered" >function(object, arcs) {</span>
<span class="cstat-no" title="statement not covered" >  var coordinates = [];</span>
<span class="cstat-no" title="statement not covered" >  var i, ii;</span>
<span class="cstat-no" title="statement not covered" >  for (i = 0, ii = object.arcs.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    coordinates[i] = ol.format.TopoJSON.concatenateArcs_(object.arcs[i], arcs);</span>
  }
<span class="cstat-no" title="statement not covered" >  return new ol.geom.MultiLineString(coordinates);</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @inheritDoc
 */
ol.format.TopoJSON.prototype.getExtensions = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return ol.format.TopoJSON.EXTENSIONS_;</span>
};
&nbsp;
&nbsp;
/**
...
ol.format.TopoJSON.prototype.readFeaturesFromObject = function(
    object, opt_options) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (object.type == 'Topology') {
