...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/featureformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> featureformat.js
    </h1>
    <div class='clearfix'>
...
211
212
213</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">940×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">940×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">877×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">940×</span>
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">940×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.Feature');
&nbsp;
...
ol.format.Feature.transformWithOptions = function(
  ...
  if (featureProjection &amp;&amp; dataProjection &amp;&amp;
    ...
    if (geometry instanceof ol.geom.Geometry) {
      ...
      transformed = ol.proj.transformExtent(
          write ? <span class="branch-0 cbranch-no" title="branch not covered" >geometry.slice() </span>: geometry,
          write ? <span class="branch-0 cbranch-no" title="branch not covered" >featureProjection </span>: dataProjection,
          write ? <span class="branch-0 cbranch-no" title="branch not covered" >dataProjection </span>: featureProjection);
    }
  } else {
  ...
  if (write &amp;&amp; opt_options &amp;&amp; opt_options.decimals) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(transformed)) {
<span class="cstat-no" title="statement not covered" >      transform(/** @type {ol.Extent} */ (transformed));</span>
    } else {
