...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/wfsformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> wfsformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.69% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>241/260</span>
      </div>
      <div class='fl pad1y space-right2'>
...
785
786
787</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">5×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.WFS');
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.schemaLocation </span>: ol.format.WFS.SCHEMA_LOCATION;
&nbsp;
  goog.base(this);
};
...
ol.format.WFS.prototype.readFeaturesFromNode = function(node, opt_options) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!features) {
...
<span class="cstat-no" title="statement not covered" >    return this.readTransactionResponseFromDocument(</span>
        /** @type {Document} */ (source));
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isNode(source)) {
<span class="cstat-no" title="statement not covered" >    return this.readTransactionResponseFromNode(/** @type {Node} */ (source));</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    var doc = ol.xml.parse(source);
    return this.readTransactionResponseFromDocument(doc);
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unknown source type');</span>
...
ol.format.WFS.prototype.readFeatureCollectionMetadata = function(source) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isDocument(source)) {
<span class="cstat-no" title="statement not covered" >    return this.readFeatureCollectionMetadataFromDocument(</span>
        /** @type {Document} */ (source));
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isNode(source)) {
<span class="cstat-no" title="statement not covered" >    return this.readFeatureCollectionMetadataFromNode(</span>
        /** @type {Node} */ (source));
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    var doc = ol.xml.parse(source);
...
<span class="branch-1 cbranch-no" title="branch not covered" >      ol.format.WFS.FEATURE_PREFIX;</span>
  var featureNS = context['featureNS'];
  node.setAttribute('typeName', featurePrefix + ':' + featureType);
  ol.xml.setAttributeNS(node, ol.format.WFS.XMLNS, 'xmlns:' + featurePrefix,
      featureNS);
  var fid = feature.getId();
  <span class="missing-if-branch" title="else path not taken" >E</span>if (fid !== undefined) {
...
ol.format.WFS.writeNative_ = function(node, nativeElement, objectStack) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (nativeElement.vendorId) {
    node.setAttribute('vendorId', nativeElement.vendorId);
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (nativeElement.safeToIgnore !== undefined) {
    node.setAttribute('safeToIgnore', nativeElement.safeToIgnore);
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (nativeElement.value !== undefined) {
...
ol.format.WFS.writeQuery_ = function(node, featureType, objectStack) {
  ...
  var prefix = featurePrefix ? featurePrefix + ':' : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
  node.setAttribute('typeName', prefix + featureType);
  if (srsName) {
    node.setAttribute('srsName', srsName);
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (featureNS) {
    ol.xml.setAttributeNS(node, ol.format.WFS.XMLNS, 'xmlns:' + featurePrefix,
        featureNS);
  }
...
ol.format.WFS.prototype.writeGetFeature = function(options) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.handle) {
<span class="cstat-no" title="statement not covered" >      node.setAttribute('handle', options.handle);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.outputFormat) {
<span class="cstat-no" title="statement not covered" >      node.setAttribute('outputFormat', options.outputFormat);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.maxFeatures !== undefined) {
<span class="cstat-no" title="statement not covered" >      node.setAttribute('maxFeatures', options.maxFeatures);</span>
    }
  ...
  var context = {
    ...
    featureNS: options.featureNS ? options.featureNS : <span class="branch-1 cbranch-no" title="branch not covered" >this.featureNS_,</span>
 ...
 * @inheritDoc
 */
ol.format.WFS.prototype.readProjectionFromDocument = <span class="fstat-no" title="function not covered" >function(doc) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(doc.nodeType == goog.dom.NodeType.DOCUMENT,</span>
      'doc.nodeType should be a DOCUMENT');
<span class="cstat-no" title="statement not covered" >  for (var n = doc.firstChild; n; n = n.nextSibling) {</span>
<span class="cstat-no" title="statement not covered" >    if (n.nodeType == goog.dom.NodeType.ELEMENT) {</span>
<span class="cstat-no" title="statement not covered" >      return this.readProjectionFromNode(n);</span>
    }
  }
