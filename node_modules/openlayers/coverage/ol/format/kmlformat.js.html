...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/kmlformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> kmlformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.3% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>891/955</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.54% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>278/368</span>
      </div>
      <div class='fl pad1y space-right2'>
...
2999
3000
3001</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">212×</span>
<span class="cline-any cline-yes">212×</span>
<span class="cline-any cline-yes">13790×</span>
<span class="cline-any cline-yes">13790×</span>
<span class="cline-any cline-yes">13790×</span>
<span class="cline-any cline-yes">13790×</span>
<span class="cline-any cline-yes">13790×</span>
...
<span class="cline-any cline-yes">35×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// FIXME http://earth.google.com/kml/1.0 namespace?
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.defaultStyle </span>: ol.format.KML.DEFAULT_STYLE_ARRAY_;
&nbsp;
  /**
   * @private
   * @type {boolean}
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.extractStyles </span>: true;
&nbsp;
  /**
   * @private
   * @type {boolean}
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.showPointNames </span>: true;
&nbsp;
};
...
ol.format.KML.createNameStyleFunction_ = function(foundStyle, name) {
  ...
  var textOffset = [0, 0];
  var textAlign = 'start';
  <span class="missing-if-branch" title="else path not taken" >E</span>if (foundStyle.getImage()) {
    var imageSize = foundStyle.getImage().getImageSize();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (imageSize &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >imageSize.length == 2)</span> {
      // Offset the label to be centered to the right of the icon, if there is
      // one.
<span class="cstat-no" title="statement not covered" >      textOffset[0] = foundStyle.getImage().getScale() * imageSize[0] / 2;</span>
<span class="cstat-no" title="statement not covered" >      textOffset[1] = -foundStyle.getImage().getScale() * imageSize[1] / 2;</span>
<span class="cstat-no" title="statement not covered" >      textAlign = 'left';</span>
    }
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!ol.object.isEmpty(foundStyle.getText())) {
...
<span class="cstat-no" title="statement not covered" >    textStyle = new ol.style.Text({</span>
      text: name,
...
&nbsp;
  return (
      ...
      function(resolution) {
        ...
        var nameStyle;
        var name = '';
        <span class="missing-if-branch" title="else path not taken" >E</span>if (drawName) {
          if (this.getGeometry()) {
...
&nbsp;
        if (style) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (drawName) {
<span class="cstat-no" title="statement not covered" >            nameStyle = ol.format.KML.createNameStyleFunction_(style[0],</span>
                name);
<span class="cstat-no" title="statement not covered" >            return style.concat(nameStyle);</span>
          }
          return style;
        }
        if (styleUrl) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (drawName) {
<span class="cstat-no" title="statement not covered" >          nameStyle = ol.format.KML.createNameStyleFunction_(defaultStyle[0],</span>
              name);
<span class="cstat-no" title="statement not covered" >          return defaultStyle.concat(nameStyle);</span>
        }
        return defaultStyle;
      });
};
...
ol.format.KML.findStyle_ = function(styleValue, defaultStyle, sharedStyles) {
  if (goog.isArray(styleValue)) {
    ...
    // a style.
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(styleValue in sharedStyles) &amp;&amp; ('#' + styleValue in sharedStyles)) {
<span class="cstat-no" title="statement not covered" >      styleValue = '#' + styleValue;</span>
    }
...
ol.format.KML.readColor_ = function(node) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (m) {
    var hexColor = m[1];
    return [
...
ol.format.KML.readStyleUrl_ = function(node) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (node.baseURI) {
<span class="cstat-no" title="statement not covered" >    return goog.Uri.resolve(node.baseURI, s).toString();</span>
  } else {
    return s;
  }
&nbsp;
...
ol.format.KML.readURI_ = function(node) {
  var s = ol.xml.getAllTextContent(node, false);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (node.baseURI) {
<span class="cstat-no" title="statement not covered" >    return goog.Uri.resolve(node.baseURI, s.trim()).toString();</span>
  } else {
    return s.trim();
  }
};
...
ol.format.KML.readScale_ = function(node) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (number !== undefined) {
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  var IconObject = 'Icon' in object ? object['Icon'] : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
  var src;
...
<span class="cstat-no" title="statement not covered" >    src = ol.format.KML.DEFAULT_IMAGE_STYLE_SRC_;</span>
  }
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (src === ol.format.KML.DEFAULT_IMAGE_STYLE_SRC_) {
<span class="cstat-no" title="statement not covered" >    anchor = ol.format.KML.DEFAULT_IMAGE_STYLE_ANCHOR_;</span>
<span class="cstat-no" title="statement not covered" >    anchorXUnits = ol.format.KML.DEFAULT_IMAGE_STYLE_ANCHOR_X_UNITS_;</span>
<span class="cstat-no" title="statement not covered" >    anchorYUnits = ol.format.KML.DEFAULT_IMAGE_STYLE_ANCHOR_Y_UNITS_;</span>
...
&nbsp;
  ...
  var heading = /** @type {number} */
      (object['heading']);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (heading !== undefined) {
<span class="cstat-no" title="statement not covered" >    rotation = ol.math.toRadians(heading);</span>
  }
&nbsp;
  var scale = /** @type {number|undefined} */
      (object['scale']);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (src == ol.format.KML.DEFAULT_IMAGE_STYLE_SRC_) {
<span class="cstat-no" title="statement not covered" >    size = ol.format.KML.DEFAULT_IMAGE_STYLE_SIZE_;</span>
<span class="cstat-no" title="statement not covered" >    if (scale === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      scale = ol.format.KML.DEFAULT_IMAGE_SCALE_MULTIPLIER_;</span>
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  var textStyle = new ol.style.Text({
    fill: new ol.style.Fill({
      color: /** @type {ol.Color} */
          ('color' in object ? object['color'] : <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_COLOR_)</span>
    }),
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  var strokeStyle = new ol.style.Stroke({
    color: /** @type {ol.Color} */
        ('color' in object ? object['color'] : <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_COLOR_)</span>,
    width: /** @type {number} */ ('width' in object ? object['width'] : <span class="branch-1 cbranch-no" title="branch not covered" >1)</span>
  });
...
<span class="cstat-no" title="statement not covered" >    flatCoordinates.push(0, 0, 0, 0);</span>
  }
};
&nbsp;
&nbsp;
...
ol.format.KML.readGxMultiTrack_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!lineStrings) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
...
ol.format.KML.readGxTrack_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!gxTrackObject) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
  var flatCoordinates = gxTrackObject.flatCoordinates;
...
ol.format.KML.readIcon_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (iconObject) {
    return iconObject;
  } else {
...
ol.format.KML.readLineString_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (flatCoordinates) {
    var lineString = new ol.geom.LineString(null);
...
ol.format.KML.readMultiGeometry_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!geometries) {
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
  ...
  if (homogeneous) {
    ...
    if (type == ol.geom.GeometryType.POINT) {
      ...
      return multiPolygon;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (type == ol.geom.GeometryType.GEOMETRY_COLLECTION) {
      return new ol.geom.GeometryCollection(geometries);
    } else {
<span class="cstat-no" title="statement not covered" >      goog.asserts.fail('Unexpected type: ' + type);</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
  } else {
    return new ol.geom.GeometryCollection(geometries);
...
ol.format.KML.readStyle_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!styleObject) {
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
...
ol.format.KML.DataParser_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (name !== null) {
...
ol.format.KML.PairDataParser_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!pairObject) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
...
ol.format.KML.PlacemarkStyleMapParser_ = function(node, objectStack) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof styleMapValue === 'string') {
    placemarkObject['styleUrl'] = styleMapValue;
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('styleMapValue has an unknown type');</span>
  }
};
&nbsp;
&nbsp;
...
ol.format.KML.innerBoundaryIsParser_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (flatLinearRing) {
...
ol.format.KML.whenParser_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (m) {
    ...
    if (m[10] &amp;&amp; m[10] != 'Z') {
      var sign = m[11] == '-' ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: 1;
      when += sign * 60 * parseInt(m[12], 10);
      <span class="missing-if-branch" title="else path not taken" >E</span>if (m[13]) {
        when += sign * 60 * 60 * parseInt(m[13], 10);
      }
    }
    whens.push(when);
  } else {
<span class="cstat-no" title="statement not covered" >    whens.push(0);</span>
  }
};
&nbsp;
&nbsp;
 ...
 * @inheritDoc
 */
ol.format.KML.prototype.getExtensions = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return ol.format.KML.EXTENSIONS_;</span>
};
&nbsp;
&nbsp;
/**
...
ol.format.KML.prototype.readDocumentOrFolder_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (features) {
    return features;
  } else {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.extractStyles_) {
...
ol.format.KML.prototype.readSharedStyle_ = function(node, objectStack) {
  ...
  goog.asserts.assert(node.localName == 'Style', 'localName should be Style');
  var id = node.getAttribute('id');
  <span class="missing-if-branch" title="else path not taken" >E</span>if (id !== null) {
    var style = ol.format.KML.readStyle_(node, objectStack);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (style) {
      var styleUri;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (node.baseURI) {
<span class="cstat-no" title="statement not covered" >        styleUri = goog.Uri.resolve(node.baseURI, '#' + id).toString();</span>
      } else {
        styleUri = '#' + id;
      }
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  var styleMapValue = ol.format.KML.readStyleMapValue_(node, objectStack);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!styleMapValue) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
  var styleUri;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (node.baseURI) {
 ...
 * @inheritDoc
 */
ol.format.KML.prototype.readFeatureFromNode = <span class="fstat-no" title="function not covered" >function(node, opt_options) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,</span>
      'node.nodeType should be ELEMENT');
<span class="cstat-no" title="statement not covered" >  if (!ol.array.includes(ol.format.KML.NAMESPACE_URIS_, node.namespaceURI)) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(node.localName == 'Placemark',</span>
      'localName should be Placemark');
<span class="cstat-no" title="statement not covered" >  var feature = this.readPlacemark_(</span>
      node, [this.getReadOptions(node, opt_options)]);
<span class="cstat-no" title="statement not covered" >  if (feature) {</span>
...
<span class="cstat-no" title="statement not covered" >      return [];</span>
    ...
    for (n = node.firstElementChild; n; n = n.nextElementSibling) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (fs) {
...
ol.format.KML.prototype.readName = function(source) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isDocument(source)) {
<span class="cstat-no" title="statement not covered" >    return this.readNameFromDocument(/** @type {Document} */ (source));</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isNode(source)) {
<span class="cstat-no" title="statement not covered" >    return this.readNameFromNode(/** @type {Node} */ (source));</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    var doc = ol.xml.parse(source);
    return this.readNameFromDocument(doc);
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unknown type for source');</span>
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
};
&nbsp;
...
ol.format.KML.prototype.readNameFromDocument = function(doc) {
  ...
  for (n = doc.firstChild; n; n = n.nextSibling) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (n.nodeType == goog.dom.NodeType.ELEMENT) {
...
ol.format.KML.prototype.readNameFromNode = function(node) {
  ...
  for (n = node.firstElementChild; n; n = n.nextElementSibling) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ol.array.includes(ol.format.KML.NAMESPACE_URIS_, n.namespaceURI) &amp;&amp;
        (localName == 'Document' ||
         localName == 'Folder' ||
         localName == 'Placemark' ||
<span class="branch-4 cbranch-no" title="branch not covered" >         localName == 'kml')</span>) {
      var name = this.readNameFromNode(n);
      if (name) {
        return name;
      }
...
ol.format.KML.prototype.readNetworkLinks = function(source) {
  var networkLinks = [];
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isDocument(source)) {
<span class="cstat-no" title="statement not covered" >    ol.array.extend(networkLinks, this.readNetworkLinksFromDocument(</span>
        /** @type {Document} */ (source)));
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isNode(source)) {
<span class="cstat-no" title="statement not covered" >    ol.array.extend(networkLinks, this.readNetworkLinksFromNode(</span>
        /** @type {Node} */ (source)));
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    var doc = ol.xml.parse(source);
...
ol.format.KML.writeColorTextNode_ = function(node, color) {
  ...
  var opacity = (rgba.length == 4) ? rgba[3] : <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
...
&nbsp;
  ...
  if (layout == ol.geom.GeometryLayout.XY ||
    ...
    dimension = 2;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (layout == ol.geom.GeometryLayout.XYZ ||
      layout == ol.geom.GeometryLayout.XYZM) {
    dimension = 3;
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unknown geometry layout');</span>
  }
&nbsp;
  var d, i;
  var ii = coordinates.length;
  var text = '';
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ii &gt; 0) {
    text += coordinates[0];
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (size) {
    iconProperties['w'] = size[0];
    iconProperties['h'] = size[1];
    var anchor = style.getAnchor(); // top-left
    var origin = style.getOrigin(); // top-left
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (origin &amp;&amp; iconImageSize &amp;&amp; origin[0] !== 0 &amp;&amp; origin[1] !== size[1]) {
      iconProperties['x'] = origin[0];
      iconProperties['y'] = iconImageSize[1] - (origin[1] + size[1]);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (anchor &amp;&amp; anchor[0] !== 0 &amp;&amp; anchor[1] !== size[1]) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (scale !== 1) {
    properties['scale'] = scale;
  }
&nbsp;
  var rotation = style.getRotation();
  <span class="missing-if-branch" title="else path not taken" >E</span>if (rotation !== 0) {
...
ol.format.KML.writeLabelStyle_ = function(node, style, objectStack) {
  ...
  var scale = style.getScale();
  <span class="missing-if-branch" title="else path not taken" >E</span>if (scale &amp;&amp; scale !== 1) {
    properties['scale'] = scale;
  }
  var parentNode = objectStack[objectStack.length - 1].node;
  var orderedKeys =
...
ol.format.KML.writeMultiGeometry_ = function(node, geometry, objectStack) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (type == ol.geom.GeometryType.MULTI_POLYGON) {
    geometries =
        (/** @type {ol.geom.MultiPolygon} */ (geometry)).getPolygons();
    factory = ol.format.KML.POLYGON_NODE_FACTORY_;
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unknown geometry type: ' + type);</span>
  }
  ol.xml.pushSerializeAndPop(context,
...
&nbsp;
  ...
  if (styleFunction) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (styles) {
      var style = goog.isArray(styles) ? styles[0] : <span class="branch-1 cbranch-no" title="branch not covered" >styles;</span>
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (features.length == 1) {
