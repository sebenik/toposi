...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/geojsonformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> geojsonformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.02% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>150/163</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// TODO: serialize dataProjection as crs member when writing
 ...
 */
ol.format.GeoJSON.readMultiLineStringGeometry_ = <span class="fstat-no" title="function not covered" >function(object) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(object.type == 'MultiLineString',</span>
      'object.type should be MultiLineString');
<span class="cstat-no" title="statement not covered" >  return new ol.geom.MultiLineString(object.coordinates);</span>
};
&nbsp;
&nbsp;
/**
 ...
 */
ol.format.GeoJSON.readMultiPointGeometry_ = <span class="fstat-no" title="function not covered" >function(object) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assert(object.type == 'MultiPoint',</span>
      'object.type should be MultiPoint');
<span class="cstat-no" title="statement not covered" >  return new ol.geom.MultiPoint(object.coordinates);</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @return {GeoJSONGeometry} GeoJSON geometry.
 */
ol.format.GeoJSON.writeMultiLineStringGeometry_ = <span class="fstat-no" title="function not covered" >function(geometry, opt_options) {</span>
...
<span class="cstat-no" title="statement not covered" >  return /** @type {GeoJSONGeometry} */ ({</span>
 ...
 * @return {GeoJSONGeometry} GeoJSON geometry.
 */
ol.format.GeoJSON.writeMultiPointGeometry_ = <span class="fstat-no" title="function not covered" >function(geometry, opt_options) {</span>
<span class="cstat-no" title="statement not covered" >  goog.asserts.assertInstanceof(geometry, ol.geom.MultiPoint,</span>
 ...
 * @inheritDoc
 */
ol.format.GeoJSON.prototype.getExtensions = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return ol.format.GeoJSON.EXTENSIONS_;</span>
};
&nbsp;
&nbsp;
/**
...
ol.format.GeoJSON.prototype.readFeaturesFromObject = function(
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (geoJSONObject.type == 'FeatureCollection') {
...
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unknown geoJSONObject.type: ' + geoJSONObject.type);</span>
...
ol.format.GeoJSON.prototype.readProjectionFromObject = function(object) {
  ...
  if (crs) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (crs.type == 'EPSG') {
...
<span class="cstat-no" title="statement not covered" >      goog.asserts.fail('Unknown crs.type: ' + crs.type);</span>
