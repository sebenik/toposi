...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/gml/gml2format.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">ol/format/gml/</a> gml2format.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">95.77% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>68/71</span>
      </div>
      <div class='fl pad1y space-right2'>
...
226
227
228</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.GML2');
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.schemaLocation </span>: ol.format.GML2.schemaLocation_;
&nbsp;
};
...
ol.format.GML2.prototype.readFlatCoordinates_ = function(node, objectStack) {
  ...
  var dim = 2;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (node.getAttribute('srsDimension')) {
...
<span class="cstat-no" title="statement not covered" >    dim = ol.format.XSD.readNonNegativeIntegerString(</span>
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (containerDimension) {
<span class="cstat-no" title="statement not covered" >    dim = ol.format.XSD.readNonNegativeIntegerString(containerDimension);</span>
  }
  var x, y, z;
  var flatCoordinates = [];
  for (var i = 0, ii = coords.length; i &lt; ii; i += dim) {
    ...
    z = (dim === 3) ? <span class="branch-0 cbranch-no" title="branch not covered" >parseFloat(coords[i + 2]) </span>: 0;
