...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/gml/gmlbaseformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">ol/format/gml/</a> gmlbaseformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.95% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>207/218</span>
      </div>
      <div class='fl pad1y space-right2'>
...
640
641
642</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">104×</span>
<span class="cline-any cline-yes">104×</span>
<span class="cline-any cline-yes">876×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">876×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">794×</span>
<span class="cline-any cline-yes">794×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// FIXME Envelopes should not be treated as geometries! readEnvelope_ is part
...
ol.format.GMLBase = function(opt_options) {
  var options = /** @type {olx.format.GMLOptions} */
      (opt_options ? opt_options : <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
&nbsp;
  /**
   * @protected
...
ol.format.GMLBase.prototype.readFeaturesInternal = function(node, objectStack) {
  ...
  if (localName == 'FeatureCollection') {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (node.namespaceURI === 'http://www.opengis.net/wfs') {
      features = ol.xml.pushParseAndPop([],
          this.FEATURE_COLLECTION_PARSERS, node,
          objectStack, this);
    } else {
<span class="cstat-no" title="statement not covered" >      features = ol.xml.pushParseAndPop(null,</span>
          this.FEATURE_COLLECTION_PARSERS, node,
          objectStack, this);
    }
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (localName == 'featureMembers' || localName == 'featureMember') {
    ...
    if (!featureType &amp;&amp; node.childNodes) {
      ...
      for (i = 0, ii = node.childNodes.length; i &lt; ii; ++i) {
        ...
        if (child.nodeType === 1) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (featureType.indexOf(ft) === -1) {
            var key = '';
            var count = 0;
...
ol.format.GMLBase.prototype.readMultiPoint = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (coordinates) {
...
ol.format.GMLBase.prototype.readFlatLinearRing_ = function(node, objectStack) {
  ...
  var ring = ol.xml.pushParseAndPop(null,
      ...
      objectStack, this);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ring) {
    return ring;
  } else {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
...
ol.format.GMLBase.prototype.readGeometryFromNode = function(node, opt_options) {
  ...
  return geometry ? geometry : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
};
&nbsp;
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    ol.object.assign(options, this.getReadOptions(node, opt_options));</span>
  }
