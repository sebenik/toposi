...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/wktformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> wktformat.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>108/125</span>
      </div>
      <div class='fl pad1y space-right2'>
...
864
865
866</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1165×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">7997×</span>
<span class="cline-any cline-yes">7997×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">527×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">9116×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">2013×</span>
<span class="cline-any cline-yes">2013×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2013×</span>
<span class="cline-any cline-yes">78×</span>
<span class="cline-any cline-yes">1935×</span>
<span class="cline-any cline-yes">402×</span>
<span class="cline-any cline-yes">1533×</span>
<span class="cline-any cline-yes">68×</span>
<span class="cline-any cline-yes">1465×</span>
...
<span class="cline-any cline-yes">871×</span>
<span class="cline-any cline-yes">871×</span>
<span class="cline-any cline-yes">6532×</span>
<span class="cline-any cline-yes">653×</span>
<span class="cline-any cline-yes">5879×</span>
...
<span class="cline-any cline-yes">1528×</span>
<span class="cline-any cline-yes">1471×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1528×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">22×</span>
<span class="cline-any cline-yes">383×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">22×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.WKT');
&nbsp;
...
ol.format.WKT.prototype.readFeatureFromText = function(text, opt_options) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (geom) {
...
ol.format.WKT.prototype.readFeaturesFromText = function(text, opt_options) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.splitCollection_ &amp;&amp;
      geometry.getType() == ol.geom.GeometryType.GEOMETRY_COLLECTION) {
    geometries = (/** @type {ol.geom.GeometryCollection} */ (geometry))
        .getGeometriesArray();
  } else {
<span class="cstat-no" title="statement not covered" >    geometries = [geometry];</span>
  }
...
ol.format.WKT.prototype.writeFeaturesText = function(features, opt_options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (features.length == 1) {
<span class="cstat-no" title="statement not covered" >    return this.writeFeatureText(features[0], opt_options);</span>
  }
  var geometries = [];
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (c === '') {
    token.type = ol.format.WKT.TokenType.EOF;
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error('Unexpected character: ' + c);</span>
  }
&nbsp;
  return token;
};
...
ol.format.WKT.Parser.prototype.parseGeometryCollectionText_ = function() {
  if (this.match(ol.format.WKT.TokenType.LEFT_PAREN)) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.match(ol.format.WKT.TokenType.RIGHT_PAREN)) {
      return geometries;
    }
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isEmptyGeometry_()) {
    return [];
  }
<span class="cstat-no" title="statement not covered" >  throw new Error(this.formatErrorMessage_());</span>
};
&nbsp;
&nbsp;
/**
