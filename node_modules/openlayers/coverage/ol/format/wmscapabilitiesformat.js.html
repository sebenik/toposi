...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/wmscapabilitiesformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> wmscapabilitiesformat.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.35% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>185/192</span>
      </div>
      <div class='fl pad1y space-right2'>
...
859
860
861</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.WMSCapabilities');
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >      node.localName == 'WMT_MS_Capabilities',</span>
  ...
  return wmsCapabilityObject ? wmsCapabilityObject : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
};
&nbsp;
&nbsp;
/**
...
ol.format.WMSCapabilities.readEXGeographicBoundingBox_ = function(node, objectStack) {
  ...
  var geographicBoundingBox = ol.xml.pushParseAndPop(
      ...
      node, objectStack);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!geographicBoundingBox) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (westBoundLongitude === undefined || southBoundLatitude === undefined ||
...
&nbsp;
  var layerObject = ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities.LAYER_PARSERS_, node, objectStack);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!layerObject) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
  var queryable =
...
ol.format.WMSCapabilities.readSizedFormatOnlineresource_ = function(node, objectStack) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (formatOnlineresource) {
    var size = [
...
ol.format.WMSCapabilities.readAuthorityURL_ = function(node, objectStack) {
  ...
  var authorityObject =
      ol.format.WMSCapabilities.readFormatOnlineresource_(node, objectStack);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (authorityObject) {
...
ol.format.WMSCapabilities.readMetadataURL_ = function(node, objectStack) {
  ...
  var metadataObject =
      ol.format.WMSCapabilities.readFormatOnlineresource_(node, objectStack);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (metadataObject) {
