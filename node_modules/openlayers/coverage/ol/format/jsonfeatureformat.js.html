...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/jsonfeatureformat.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> jsonfeatureformat.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.format.JSONFeature');
&nbsp;
...
ol.format.JSONFeature.prototype.getObject_ = function(source) {
  if (goog.isObject(source)) {
    ...
    return object ? /** @type {Object} */ (object) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
  } else {
 ...
 * @inheritDoc
 */
ol.format.JSONFeature.prototype.writeFeature = <span class="fstat-no" title="function not covered" >function(feature, opt_options) {</span>
<span class="cstat-no" title="statement not covered" >  return JSON.stringify(this.writeFeatureObject(feature, opt_options));</span>
};
&nbsp;
&nbsp;
/**
