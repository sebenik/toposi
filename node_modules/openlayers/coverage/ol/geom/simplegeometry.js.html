...
<html lang="en">
<head>
    <title>Code coverage report for ol/geom/simplegeometry.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/geom/</a> simplegeometry.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.52% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>99/107</span>
      </div>
      <div class='fl pad1y space-right2'>
...
310
311
312</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2126×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1417×</span>
<span class="cline-any cline-yes">1274×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1640×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1447×</span>
<span class="cline-any cline-yes">1447×</span>
<span class="cline-any cline-yes">1657×</span>
<span class="cline-any cline-yes">30×</span>
<span class="cline-any cline-yes">30×</span>
<span class="cline-any cline-yes">30×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1627×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1417×</span>
<span class="cline-any cline-yes">1417×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.geom.SimpleGeometry');
&nbsp;
...
ol.geom.SimpleGeometry.getLayoutForStride_ = function(stride) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (stride == 4) {
    return ol.geom.GeometryLayout.XYZM;
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('unsupported stride: ' + stride);</span>
  }
};
&nbsp;
&nbsp;
...
ol.geom.SimpleGeometry.getStrideForLayout = function(layout) {
  if (layout == ol.geom.GeometryLayout.XY) {
    ...
    return 3;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (layout == ol.geom.GeometryLayout.XYZM) {
    return 4;
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('unsupported layout: ' + layout);</span>
  }
};
&nbsp;
&nbsp;
 ...
 * @api
 */
ol.geom.SimpleGeometry.prototype.rotate = <span class="fstat-no" title="function not covered" >function(angle, anchor) {</span>
<span class="cstat-no" title="statement not covered" >  var flatCoordinates = this.getFlatCoordinates();</span>
<span class="cstat-no" title="statement not covered" >  if (flatCoordinates) {</span>
<span class="cstat-no" title="statement not covered" >    var stride = this.getStride();</span>
<span class="cstat-no" title="statement not covered" >    ol.geom.flat.transform.rotate(</span>
...
ol.geom.transformSimpleGeometry2D = function(simpleGeometry, transform, opt_dest) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!flatCoordinates) {
