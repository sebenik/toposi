...
<html lang="en">
<head>
    <title>Code coverage report for ol/geom/circle.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/geom/</a> circle.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.geom.Circle');
&nbsp;
...
ol.geom.Circle.prototype.closestPointXY = function(x, y, closestPoint, minSquaredDistance) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (squaredDistance &lt; minSquaredDistance) {
    var i;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (squaredDistance === 0) {
<span class="cstat-no" title="statement not covered" >      for (i = 0; i &lt; this.stride; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        closestPoint[i] = flatCoordinates[i];</span>
      }
    } else {
