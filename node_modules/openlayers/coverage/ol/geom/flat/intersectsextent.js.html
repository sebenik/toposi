...
<html lang="en">
<head>
    <title>Code coverage report for ol/geom/flat/intersectsextent.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">ol/geom/flat/</a> intersectsextent.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.geom.flat.intersectsextent');
&nbsp;
...
ol.geom.flat.intersectsextent.lineString = function(flatCoordinates, offset, end, stride, extent) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (coordinatesExtent[1] &gt;= extent[1] &amp;&amp;
...
ol.geom.flat.intersectsextent.linearRing = function(flatCoordinates, offset, end, stride, extent) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.geom.flat.contains.linearRingContainsXY(
