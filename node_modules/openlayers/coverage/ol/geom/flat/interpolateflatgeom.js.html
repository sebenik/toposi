...
<html lang="en">
<head>
    <title>Code coverage report for ol/geom/flat/interpolateflatgeom.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">ol/geom/flat/</a> interpolateflatgeom.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">95.45% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>105/110</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.geom.flat.interpolate');
&nbsp;
...
ol.geom.flat.interpolate.lineString = function(flatCoordinates, offset, end, stride, fraction, opt_dest) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (n === 0) {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('n cannot be 0');</span>
  } else if (n == 1) {
...
ol.geom.flat.lineStringCoordinateAtM = function(flatCoordinates, offset, end, stride, m, extrapolate) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (end == offset) {
