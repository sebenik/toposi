  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>30/54</span>
      </div>
      <div class='fl pad1y space-right2'>
 ...
 */
ol.DragBoxEvent = <span class="fstat-no" title="function not covered" >function(type, coordinate, mapBrowserEvent) {</span>
...
&nbsp;
   ...
   * @api
   */
<span class="cstat-no" title="statement not covered" >  this.mapBrowserEvent = mapBrowserEvent;</span>
&nbsp;
};
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.boxEndCondition </span>: ol.interaction.DragBox.defaultBoxEndCondition;
};
 ...
 */
ol.interaction.DragBox.defaultBoxEndCondition = <span class="fstat-no" title="function not covered" >function(mapBrowserEvent,</span>
    startPixel, endPixel) {
<span class="cstat-no" title="statement not covered" >  var width = endPixel[0] - startPixel[0];</span>
<span class="cstat-no" title="statement not covered" >  var height = endPixel[1] - startPixel[1];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.dispatchEvent(new ol.DragBoxEvent(ol.DragBoxEventType.BOXDRAG,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.boxEndCondition_(mapBrowserEvent,</span>
