...
<html lang="en">
<head>
    <title>Code coverage report for ol/interaction/translateinteraction.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/interaction/</a> translateinteraction.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">2×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.interaction.Translate');
...
&nbsp;
   ...
   * @private
   */
  this.features_ = options.features !== undefined ? options.features : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
&nbsp;
  /**
   * @type {ol.Feature}
   * @private
...
ol.interaction.Translate.handleUpEvent_ = function(event) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.lastCoordinate_) {
    this.lastCoordinate_ = null;
    ol.interaction.Translate.handleMoveEvent_.call(this, event);
    this.dispatchEvent(
        new ol.interaction.TranslateEvent(
...
&nbsp;
    ...
    } else <span class="cstat-no" title="statement not covered" >if (this.lastFeature_) {</span>
<span class="cstat-no" title="statement not covered" >      var geom = this.lastFeature_.getGeometry();</span>
<span class="cstat-no" title="statement not covered" >      geom.translate(deltaX, deltaY);</span>
<span class="cstat-no" title="statement not covered" >      this.lastFeature_.setGeometry(geom);</span>
    }
&nbsp;
...
&nbsp;
    ...
    elem.style.cursor = !this.lastCoordinate_ ?
        'grabbing' : (isSelected ? 'grab' : <span class="branch-1 cbranch-no" title="branch not covered" >'pointer')</span>;
&nbsp;
  } else {
    elem.style.cursor = this.previousCursor_ !== undefined ?
        this.previousCursor_ : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    this.previousCursor_ = undefined;
  }
};
&nbsp;
