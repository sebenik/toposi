...
<html lang="en">
<head>
    <title>Code coverage report for ol/layer/layergroup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/layer/</a> layergroup.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.44% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>85/90</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.layer.Group');
&nbsp;
...
ol.layer.Group.prototype.handleLayerChange_ = function() {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.getVisible()) {
    this.changed();
  }
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.listenerKeys_[id].forEach(ol.events.unlistenByKey);</span>
  }
 ...
 * @inheritDoc
 */
ol.layer.Group.prototype.getLayersArray = <span class="fstat-no" title="function not covered" >function(opt_array) {</span>
<span class="cstat-no" title="statement not covered" >  var array = opt_array !== undefined ? opt_array : [];</span>
<span class="cstat-no" title="statement not covered" >  this.getLayers().forEach(<span class="fstat-no" title="function not covered" >function(layer) {</span></span>
<span class="cstat-no" title="statement not covered" >    layer.getLayersArray(array);</span>
  });
...
ol.layer.Group.prototype.getLayerStatesArray = function(opt_states) {
  var states = opt_states !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >opt_states </span>: [];
&nbsp;
