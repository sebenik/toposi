...
<html lang="en">
<head>
    <title>Code coverage report for ol/layer/vectorlayer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/layer/</a> vectorlayer.js
    </h1>
    <div class='clearfix'>
...
185
186
187</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">168×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.layer.Vector');
&nbsp;
...
&nbsp;
  var options = opt_options ?
      opt_options : /** @type {olx.layer.VectorOptions} */ (<span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
&nbsp;
  goog.asserts.assert(
      options.renderOrder === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >!options.renderOrder </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >      goog.isFunction(options.renderOrder),</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.renderBuffer </span>: 100;
&nbsp;
  /**
   * User provided style.
...
<span class="branch-2 cbranch-no" title="branch not covered" >      goog.isFunction(renderOrder),</span>
      'renderOrder must be a comparator function');
