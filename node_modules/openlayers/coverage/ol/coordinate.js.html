...
<html lang="en">
<head>
    <title>Code coverage report for ol/coordinate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ol/</a> coordinate.js
    </h1>
    <div class='clearfix'>
...
365
366
367</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.Coordinate');
...
ol.coordinate.closestOnSegment = function(coordinate, segment) {
  ...
  var along = (dx === 0 &amp;&amp; dy === 0) ? 0 :
      ((dx * (x0 - x1)) + (dy * (y0 - y1))) / ((dx * dx + dy * dy) || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>;
  var x, y;
  if (along &lt;= 0) {
    x = x1;
    y = y1;
...
ol.coordinate.degreesToStringHDMS_ = function(degrees, hemispheres, opt_fractionDigits) {
  ...
  return Math.floor(x / 3600) + '\u00b0 ' +
      ...
      hemispheres.charAt(normalizedDegrees &lt; 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0);
};
&nbsp;
&nbsp;
/**
