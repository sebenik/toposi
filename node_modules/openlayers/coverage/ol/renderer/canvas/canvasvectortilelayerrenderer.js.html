  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>242/272</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">62.22% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>56/90</span>
      </div>
      <div class='fl pad1y space-right2'>
...
509
510
511</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
  ...
  for (i = 0, ii = tilesToDraw.length; i &lt; ii; ++i) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (width &lt; unscaledPixelTileSize / 4 || width &gt; unscaledPixelTileSize * 4) {
<span class="cstat-no" title="statement not covered" >      if (pixelSpace) {</span>
<span class="cstat-no" title="statement not covered" >        origin = ol.extent.getTopLeft(tileExtent);</span>
<span class="cstat-no" title="statement not covered" >        tileTransform = ol.vec.Mat4.makeTransform2D(this.tmpTransform_,</span>
            offsetX, offsetY,
...
<span class="cstat-no" title="statement not covered" >        tileTransform = transform;</span>
      }
<span class="cstat-no" title="statement not covered" >      replayState.replayGroup.replay(replayContext, pixelRatio,</span>
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (replayState.resolution !== resolution ||
<span class="branch-1 cbranch-no" title="branch not covered" >          replayState.rotation !== rotation)</span> {
...
&nbsp;
  ...
  if (pixelSpace) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!ol.proj.equivalent(projection, tileProjection)) {
      reproject = true;
...
&nbsp;
  ...
  function renderFeature(feature) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (styles) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!goog.isArray(styles)) {
...
<span class="cstat-no" title="statement not covered" >      origin = ol.extent.getTopLeft(tileExtent);</span>
<span class="cstat-no" title="statement not covered" >      tilePixelRatio = source.getTilePixelRatio(pixelRatio);</span>
 ...
 * @private
 */
ol.renderer.canvas.VectorTileLayer.prototype.handleStyleImageChange_ = <span class="fstat-no" title="function not covered" >function(event) {</span>
