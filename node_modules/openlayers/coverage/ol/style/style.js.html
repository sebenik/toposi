...
<html lang="en">
<head>
    <title>Code coverage report for ol/style/style.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/style/</a> style.js
    </h1>
    <div class='clearfix'>
...
373
374
375</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">112×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.style.GeometryFunction');
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.geometry !== undefined) {
<span class="cstat-no" title="statement not covered" >    this.setGeometry(options.geometry);</span>
  }
&nbsp;
  /**
   * @private
...
ol.style.Style.prototype.setGeometry = function(geometry) {
  if (goog.isFunction(geometry)) {
    ...
    this.geometryFunction_ = ol.style.defaultGeometryFunction;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (geometry !== undefined) {
