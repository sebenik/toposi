...
<html lang="en">
<head>
    <title>Code coverage report for ol/style/atlasmanager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/style/</a> atlasmanager.js
    </h1>
    <div class='clearfix'>
...
435
436
437</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.style.Atlas');
...
<span class="branch-0 cbranch-no" title="branch not covered" >          ol.MAX_ATLAS_SIZE </span>: ol.WEBGL_MAX_TEXTURE_SIZE !== undefined ?
<span class="branch-0 cbranch-no" title="branch not covered" >              ol.WEBGL_MAX_TEXTURE_SIZE </span>: 2048;
&nbsp;
  /**
   ...
   * @type {number}
   */
  this.space_ = options.space !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >options.space </span>: 1;
&nbsp;
  /**
   * @private
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!info) {
...
<span class="cstat-no" title="statement not covered" >  goog.asserts.fail('Failed to add to atlasmanager');</span>
};
&nbsp;
&nbsp;
/**
