...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/imagestaticsource.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> imagestaticsource.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">54×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.source.ImageStatic');
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.crossOrigin </span>: null;
&nbsp;
  var /** @type {ol.ImageLoadFunctionType} */ imageLoadFunction =
      options.imageLoadFunction !== undefined ?
<span class="branch-0 cbranch-no" title="branch not covered" >      options.imageLoadFunction </span>: ol.source.Image.defaultImageLoadFunction;
&nbsp;
  goog.base(this, {
...
ol.source.ImageStatic.prototype.getImageInternal = function(extent, resolution, pixelRatio, projection) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ol.extent.intersects(extent, this.image_.getExtent())) {
    return this.image_;
  }
