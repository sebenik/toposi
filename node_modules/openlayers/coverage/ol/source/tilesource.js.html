...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/tilesource.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> tilesource.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.43% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>85/94</span>
      </div>
      <div class='fl pad1y space-right2'>
...
362
363
364</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.source.Tile');
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.tilePixelRatio </span>: 1;
&nbsp;
  /**
   * @protected
 ...
 */
ol.source.Tile.prototype.expireCache = <span class="fstat-no" title="function not covered" >function(projection, usedTiles) {</span>
<span class="cstat-no" title="statement not covered" >  var tileCache = this.getTileCacheForProjection(projection);</span>
<span class="cstat-no" title="statement not covered" >  if (tileCache) {</span>
<span class="cstat-no" title="statement not covered" >    tileCache.expireCache(usedTiles);</span>
  }
};
&nbsp;
&nbsp;
...
ol.source.Tile.prototype.forEachLoadedTile = function(projection, z, tileRange, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!tileCache) {
 ...
 */
ol.source.Tile.prototype.getGutter = <span class="fstat-no" title="function not covered" >function(projection) {</span>
 ...
 */
ol.source.Tile.prototype.getOpaque = <span class="fstat-no" title="function not covered" >function(projection) {</span>
<span class="cstat-no" title="statement not covered" >  return this.opaque_;</span>
};
&nbsp;
&nbsp;
/**
 * @inheritDoc
 */
ol.source.Tile.prototype.getResolutions = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.tileGrid.getResolutions();</span>
};
&nbsp;
&nbsp;
/**
...
ol.source.Tile.prototype.getTilePixelSize = function(z, pixelRatio, projection) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (tilePixelRatio == 1) {
    return tileSize;
  } else {
<span class="cstat-no" title="statement not covered" >    return ol.size.scale(tileSize, tilePixelRatio, this.tmpSize);</span>
  }
};
&nbsp;
&nbsp;
