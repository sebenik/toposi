...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/rastersource.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> rastersource.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.67% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>148/158</span>
      </div>
      <div class='fl pad1y space-right2'>
...
512
513
514</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.source.Raster');
...
&nbsp;
   ...
   * @type {number}
   */
  this.threads_ = options.threads !== undefined ? options.threads : <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
&nbsp;
  /**
   * @private
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.allSourcesReady_()) {
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isDirty_(extent, resolution)) {
<span class="cstat-no" title="statement not covered" >    return this.renderedImageCanvas_;</span>
  }
&nbsp;
...
ol.source.Raster.prototype.allSourcesReady_ = function() {
  ...
  for (var i = 0, ii = this.renderers_.length; i &lt; ii; ++i) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (source.getState() !== ol.source.State.READY) {
<span class="cstat-no" title="statement not covered" >      ready = false;</span>
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!output) {
    // job aborted
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
ol.source.Raster.getImageData_ = function(renderer, frameState, layerState) {
  ...
  if (!ol.source.Raster.context_) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (canvas.width !== width || canvas.height !== height) {
<span class="cstat-no" title="statement not covered" >      ol.source.Raster.context_ = ol.dom.createCanvasContext2D(width, height);</span>
    } else {
...
ol.source.Raster.createRenderer_ = function(source) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (source instanceof ol.source.Image) {
    renderer = ol.source.Raster.createImageRenderer_(source);
  } else {
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('Unsupported source type: ' + source);</span>
  }
  return renderer;
};
&nbsp;
