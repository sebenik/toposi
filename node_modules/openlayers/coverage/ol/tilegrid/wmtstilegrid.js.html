...
<html lang="en">
<head>
    <title>Code coverage report for ol/tilegrid/wmtstilegrid.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/tilegrid/</a> wmtstilegrid.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.tilegrid.WMTS');
&nbsp;
 ...
 * @api
 */
ol.tilegrid.WMTS.prototype.getMatrixIds = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.matrixIds_;</span>
};
&nbsp;
&nbsp;
/**
...
&nbsp;
  matrixSet[matrixIdsPropName].forEach(function(elt, index, array) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (switchOriginXY) {
<span class="cstat-no" title="statement not covered" >      origins.push([elt[topLeftCornerPropName][1],</span>
    ...
    tileSizes.push(tileWidth == tileHeight ?
        tileWidth : <span class="branch-1 cbranch-no" title="branch not covered" >[tileWidth, tileHeight])</span>;
