...
<html lang="en">
<head>
    <title>Code coverage report for ol/color/color.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/color/</a> color.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">240×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// We can't use goog.color or goog.color.alpha because they interally use a hex
      ...
      return (
          ...
          function(s) {
            ...
            if (cache.hasOwnProperty(s)) {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (cacheSize &gt;= MAX_CACHE_SIZE) {
<span class="cstat-no" title="statement not covered" >                var i = 0;</span>
<span class="cstat-no" title="statement not covered" >                var key;</span>
<span class="cstat-no" title="statement not covered" >                for (key in cache) {</span>
...
<span class="cstat-no" title="statement not covered" >                    --cacheSize;</span>
                  }
                }
              }
...
&nbsp;
  var isHex = false;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.ENABLE_NAMED_COLORS &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >goog.color.names.hasOwnProperty(s))</span> {
<span class="cstat-no" title="statement not covered" >    s = goog.color.names[s];</span>
<span class="cstat-no" title="statement not covered" >    isHex = true;</span>
  }
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if ((match = ol.color.rgbColorRe_.exec(s))) { // rgb()
    r = Number(match[1]);
    g = Number(match[2]);
    b = Number(match[3]);
    color = [r, g, b, 1];
...
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail(s + ' is not a valid color');</span>
  }
&nbsp;
};
&nbsp;
