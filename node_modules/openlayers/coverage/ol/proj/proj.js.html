...
<html lang="en">
<head>
    <title>Code coverage report for ol/proj/proj.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/proj/</a> proj.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.19% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>219/235</span>
      </div>
      <div class='fl pad1y space-right2'>
...
856
857
858</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">24956×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">2668×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">486×</span>
<span class="cline-any cline-yes">486×</span>
<span class="cline-any cline-yes">484×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">486×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">5439×</span>
<span class="cline-any cline-yes">4670×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">10885×</span>
<span class="cline-any cline-yes">10885×</span>
<span class="cline-any cline-yes">10885×</span>
<span class="cline-any cline-yes">10885×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">555×</span>
<span class="cline-any cline-yes">555×</span>
<span class="cline-any cline-yes">555×</span>
<span class="cline-any cline-yes">555×</span>
<span class="cline-any cline-yes">555×</span>
<span class="cline-any cline-yes">2018×</span>
<span class="cline-any cline-yes">2018×</span>
<span class="cline-any cline-yes">2018×</span>
<span class="cline-any cline-yes">2018×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">6264×</span>
<span class="cline-any cline-yes">6264×</span>
<span class="cline-any cline-yes">939×</span>
<span class="cline-any cline-yes">5325×</span>
<span class="cline-any cline-yes">4644×</span>
<span class="cline-any cline-yes">4644×</span>
<span class="cline-any cline-yes">4644×</span>
<span class="cline-any cline-yes">4644×</span>
<span class="cline-any cline-yes">4644×</span>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.proj');
...
<span class="branch-0 cbranch-no" title="branch not covered" >      options.getPointResolution </span>: this.getPointResolution_;
&nbsp;
  /**
   * @private
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ol.ENABLE_PROJ4JS) {
 ...
 * @api
 */
ol.proj.Projection.prototype.setWorldExtent = <span class="fstat-no" title="function not covered" >function(worldExtent) {</span>
<span class="cstat-no" title="statement not covered" >  this.worldExtent_ = worldExtent;</span>
};
&nbsp;
&nbsp;
/**
...
* @api
*/
ol.proj.Projection.prototype.setGetPointResolution = <span class="fstat-no" title="function not covered" >function(func) {</span>
<span class="cstat-no" title="statement not covered" >  this.getPointResolutionFunc_ = func;</span>
};
&nbsp;
&nbsp;
/**
...
ol.proj.Projection.prototype.getPointResolution_ = function(resolution, point) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (units == ol.proj.Units.DEGREES) {
<span class="cstat-no" title="statement not covered" >    return resolution;</span>
  } else {
...
ol.proj.getTransformFromProjections = function(sourceProjection, destinationProjection) {
  ...
  var transform;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (sourceCode in transforms &amp;&amp; destinationCode in transforms[sourceCode]) {
    transform = transforms[sourceCode][destinationCode];
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (transform === undefined) {
<span class="cstat-no" title="statement not covered" >    goog.asserts.assert(transform !== undefined, 'transform should be defined');</span>
<span class="cstat-no" title="statement not covered" >    transform = ol.proj.identityTransform;</span>
  }
  return transform;
};
&nbsp;
 ...
 */
ol.proj.identityTransform = <span class="fstat-no" title="function not covered" >function(input, opt_output, opt_dimension) {</span>
<span class="cstat-no" title="statement not covered" >  if (opt_output !== undefined &amp;&amp; input !== opt_output) {</span>
    // TODO: consider making this a warning instead
<span class="cstat-no" title="statement not covered" >    goog.asserts.fail('This should not be used internally.');</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, ii = input.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      opt_output[i] = input[i];</span>
    }
<span class="cstat-no" title="statement not covered" >    input = opt_output;</span>
  }
...
ol.proj.cloneTransform = function(input, opt_output, opt_dimension) {
  var output;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opt_output !== undefined) {
<span class="cstat-no" title="statement not covered" >    for (var i = 0, ii = input.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      opt_output[i] = input[i];</span>
    }
<span class="cstat-no" title="statement not covered" >    output = opt_output;</span>
  } else {
    output = input.slice();
  }
  return output;
 ...
 */
ol.proj.transformWithProjections = <span class="fstat-no" title="function not covered" >function(point, sourceProjection, destinationProjection) {</span>
<span class="cstat-no" title="statement not covered" >  var transformFn = ol.proj.getTransformFromProjections(</span>
      sourceProjection, destinationProjection);
<span class="cstat-no" title="statement not covered" >  return transformFn(point);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
