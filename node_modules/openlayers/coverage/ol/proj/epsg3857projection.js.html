...
<html lang="en">
<head>
    <title>Code coverage report for ol/proj/epsg3857projection.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/proj/</a> epsg3857projection.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">944×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">944×</span>
...
<span class="cline-any cline-yes">34×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.proj.EPSG3857');
&nbsp;
...
ol.proj.EPSG3857.toEPSG4326 = function(input, opt_output, opt_dimension) {
  var length = input.length,
      ...
      output = opt_output;
  if (output === undefined) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (dimension &gt; 2) {
      // preserve values beyond second dimension
<span class="cstat-no" title="statement not covered" >      output = input.slice();</span>
    } else {
      output = new Array(length);
    }
  }
